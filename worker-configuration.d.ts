/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example --env-interface=CloudflareBindings` (hash: 1acda5904c494d7df2a6a8990fcfb189)
...
interface __BaseEnv_CloudflareBindings {
	...
	VITE_DEVTOOLS: string;
	VITE_FORWARD_CONSOLE: string;
	WRANGLER_LOG: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "port" | "BUN_VERSION" | "PORT" | "NODE_ENV" | "PURGE_KEY" | "GITHUB_TOKEN" | "DISABLE_CACHE" | "ALLOWED_HOSTS" | "VITE_DEVTOOLS" | "VITE_FORWARD_CONSOLE" | "WRANGLER_LOG">> {}
}
